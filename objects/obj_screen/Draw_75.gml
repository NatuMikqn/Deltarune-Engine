...
if (_dpsize.get_min() > 0){
	if (dotbydot){
		//surface_set_target(border_mask);
		
		//draw_sprite_ext(spr_pixel, 0, backblur_pos.x, backblur_pos.y, backblur_size, backblur_size, 0, c_gray, 1);
		
		//draw_sprite_ext(spr_pixel, 0, 0, 0, screen_size.x, screen_size.y, 0, c_white, 1)
